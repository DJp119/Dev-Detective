...
function init() {
  ...
  //  to set according to browser default 
  // Check if the user's preferred color scheme is dark
if (window.matchMedia && window.matchMedia('(prefers-color-scheme: dark)').matches) {
  // Dark mode is preferred, set your dark mode here
  enableDarkMode();
} else {
  // Light mode is preferred, set your light mode here
  enableLightMode();
}
...
// to Get the value from past preference in this site
  ...
  //   lightModeProperties();
  // }
  //by default, Your own Id  ki info show krre h UI pr
  getUserData(url + "DJP119");
}
